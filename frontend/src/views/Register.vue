<template>
  <div class="register-page">
    <div class="register-container">
      ...
      <el-form ref="registerForm" :model="formData" :rules="rules" @submit.prevent="handleRegister">
        ...
        <el-form-item label="用户名（可选）" prop="username">
          <el-input v-model="formData.username" placeholder="不填将自动生成" maxlength="20" clearable />
        </el-form-item>
